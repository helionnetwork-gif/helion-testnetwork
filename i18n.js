...
(function (global) {
  const STRINGS = {
      ...
      'wallet.usdcHint': 'Vain testnet — ei oikeaa USD. Spot HEL/USDC -kauppaan.',
      ...
      'spot.subtitle': 'HEL/BNB · Matching Engine',
      ...
      'spot.buyBtc': 'Osta HEL',
      'spot.sellBtc': 'Myy HEL',
      'spot.banner': 'Testnet-terminaali · HEL/BNB · sisäinen matching · market maker · maker 0.08% / taker 0.1%',
      'spot.usdtAvail': 'BNB saatavilla',
      'spot.btcAvail': 'HEL saatavilla',
      'spot.locked': 'Lukittu',
      'spot.equity': 'Equity',
      'spot.priceUsdt': 'Hinta (BNB)',
      'spot.sizeBtc': 'Koko (HEL)',
      'spot.total': 'Yhteensä',
      'spot.time': 'Aika',
      'spot.side': 'Suunta',
      'spot.type': 'Tyyppi',
      ...
      'guide.s4spot': 'Spot — sisäinen HEL/BNB order book, limit/market/stop, market maker.',
      ...
      'admin.mmDesc': 'Pitää HEL/BNB-orderbookin markkinahinnan ympärillä (sisäinen matching). Käynnistä adminina.',
    ...
    en: {
      ...
      'wallet.usdcHint': 'Testnet only — not real USD. For Spot HEL/USDC.',
      ...
      'guide.s4spot': 'Spot — internal HEL/BNB order book, limit/market/stop, market maker.',
      ...
      'admin.mmDesc': 'Keeps the HEL/BNB order book around market price (internal matching). Start as admin.',
